...
public class LoginPage {
	...
	private WebElement fieldWithIcons;
...
//		Log4j.logIntoFile("path/to/file", "Entering data");
	}
	...
	public boolean isFieldWithIconsDisplayed() {
		return fieldWithIcons.isDisplayed();
	}
